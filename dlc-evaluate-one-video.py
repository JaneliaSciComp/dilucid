...
path_to_this_scripts_folder = os.path.dirname(path_to_this_script)
dlc_folder_path = os.path.join(path_to_this_scripts_folder, "dlc")
#sys.path.append(dlc_folder_path)
...
modelfolder = os.path.join(network_folder_path, 
...
if storedata_as_csv :
    csv_file_path = replace_extension(dataname, ".csv")
